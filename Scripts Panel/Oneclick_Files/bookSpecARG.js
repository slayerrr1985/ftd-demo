...
var bookSpec =
{
    custom_export_folder: "indesign_export_ARG/",
    ...
    p_:
    {
        // ARGENTINA - Base ESO
        // - UNIDAD
        'script_UNIT': function()
        {
            var unit = scope.bookContent.getLastByTag ('h1');
        
            if (unit)
            {                
                if (((/\d/.test (scope.currContents)) && (scope.currContents.length < 4)) || (/>\d<\//.test (scope.currContents))) unit.contents.unshift (scope.currContents.trim () + ' ');
                else                                                                                                               unit.contents.push    (' ' + scope.currContents.trim ());
            }
            else scope.bookContent.nodeAppend ('h1', 'page-header block-1', undefined, [scope.currContents]);
        },
        
        '[No Paragraph Style]': function () { if (scope.currParagraph.fillColor.name === 'New Color Swatch') bookSpec.p_['script_UNIT'] (); },        
        'Titulo capitulo':      function () { bookSpec.p_['script_UNIT'] (); },
        
        
        // - EPIGRAFE
        'seccion pagina' : function()
        {
            scope.bookContent.nodeAppend ('h2', 'page-subheader-st1 block-1', undefined, [scope.currContents.trim ()]);                    
            scope.workingNode = scope.bookContent;
        },
        
        'Titulo tema' : function()
        {
            scope.bookContent.nodeAppend ('h2', 'page-subheader-st1 block-2', undefined, [scope.currContents.trim ()]);                    
            scope.workingNode = scope.bookContent;
        },
        
        // SUBEPIGRAFE
        'Subtitulo tema' : function()
        {
            scope.bookContent.nodeAppend ('h3', 'epigraph', undefined, [scope.currContents.trim ()]);                    
            scope.workingNode = scope.bookContent;
        },        
        
        'Titulo fragmento' : function()
        {
            scope.bookContent.nodeAppend ('h3', 'epigraph', undefined, [scope.currContents.trim ()]);                    
            scope.workingNode = scope.bookContent;
        },   
        ...
        'titulillo' : function()
        {
            scope.bookContent.nodeAppend ('h4', 'epigraph', undefined, [scope.currContents.trim ()]);                    
            scope.workingNode = scope.bookContent;
        },           
        ...
        'bajada' : function()
        {
            scope.workingNode.nodeAppend ('blockquote', undefined, undefined, [scope.currContents.trim ()]);
        },
        
        'fuente' : function()
        {
            scope.workingNode.nodeAppend ('cite', 'tinted', undefined, [scope.currContents.trim ()]);
        },
        
              
        
        // Otros       
        'titulo el autor y el contexto/ glosario' : function()
        {            
            //scope.workingNode.nodeAppend ('section', 'box-brown main-body-extended', undefined, [scope.currContents]);
            bookSpec.p_['modelDoubleBoxOpener']('section', 'box-brown main-body-extended', 'section', '');
            scope.workingNode.nodeAppend ('h5', 'box-upper-title', undefined, [scope.currContents.trim ()]);
            bookSpec.p_['modelBoxCloser']();
        },                
        'seccion plaqueta lateral (plaqueta lateral)' : function()
        {
            scope.workingNode.nodeAppend ('p', 'box-full-width', undefined, [scope.currContents.trim ()]);
        },
        'titulillo plaqueta lateral (plaqueta lateral)' : function()
        {
            scope.workingNode.nodeAppend ('p', 'box-full-width', undefined, [scope.currContents.trim ()]);
        },
        'texto plaqueta lateral (plaqueta lateral)' : function()
        {
            scope.workingNode.nodeAppend ('p', 'box-full-width', undefined, [scope.currContents.trim ()]);
        },
        'consigna plaqueta lateral (plaqueta lateral)' : function()
        {
            scope.workingNode.nodeAppend ('p', 'box-full-width', undefined, [scope.currContents.trim ()]);
        },
        
        'texto glosario' : function()
        {
            scope.workingNode.nodeAppend ('p', 'box-full-width', undefined, [scope.currContents.trim ()]);
        },        
        
        'consigna 123 70% grisado': function()
        {
            bookSpec.p_['modelDoubleBoxOpener']('section', 'marginal', 'section', 'marginal_content');
            scope.workingNode.nodeAppend ('p', undefined, undefined, [scope.currContents.trim ()]);
            bookSpec.p_['modelBoxCloser']();
        },
              
        
        'nota birome': function()
        {
            bookSpec.p_['modelDoubleBoxOpener']('section', 'marginal', 'section', 'marginal_content');
            scope.workingNode.nodeAppend ('p', undefined, undefined, [scope.currContents.trim ()]);
            bookSpec.p_['modelBoxCloser']();
        ...
        // FIN ARGENTINA (algunas de las partes siguientes es posible que sean llamadas por lo anterior, si se borran ¡con cuidado!
    ...
    htmlInitialisation: function()
    {
        var head =
        {
            ...
            mNode0_0: 'meta',mProperties0_0: 'charset<utf-8',
            mNode0_1: 'meta',mProperties0_1: 'name<book-editor<<group< <<order< <<page< ',
            mNode0_2: 'link',mProperties0_2: 'href<css/styles.css<<rel<stylesheet<<type<text/css',
            mNode0_3: 'link',mProperties0_3: 'href<css/book.css<<rel<stylesheet<<type<text/css'
        ...
        scope.bookContent = scope.html.last();
    },
